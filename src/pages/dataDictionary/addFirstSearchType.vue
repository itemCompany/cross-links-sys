  ...
  export default {
    ...
    methods:{
        save(){
            ...
            this.$post(this.$api.dataDictionary.saveOrUpdateMt,params).then(res=>{
        ...
        modifyData(){
            if (this.$route.query.content) {
                this.typeList[0].value = this.content.typeName;
                this.typeList[1].value = this.content.typeCode;
                this.typeList[2].value = this.content.description;
                this.typeList[3].value = this.content.status;
